    ...
    <div>
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">在线教育系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="部门主管姓名" class="input" v-if="tableName=='bumenzhuguan'">
                            <el-input v-model="ruleForm.bumenzhuguanName" autocomplete="off" placeholder="部门主管姓名"  />
                        </el-form-item>
                        <el-form-item label="部门主管手机号" class="input" v-if="tableName=='bumenzhuguan'">
                            <el-input v-model="ruleForm.bumenzhuguanPhone" autocomplete="off" placeholder="部门主管手机号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='bumenzhuguan'">
                            <el-input v-model="ruleForm.bumenzhuguanEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
        ...
        methods: {
            ...
            login() {
                            ...
                            if(this.ruleForm.repetitionPassword != this.ruleForm.password){
                             ...
                             if('bumenzhuguan' == this.tableName && this.ruleForm.bumenzhuguanPhone&&(!this.$validate.isMobile(this.ruleForm.bumenzhuguanPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('bumenzhuguan' == this.tableName && this.ruleForm.bumenzhuguanEmail&&(!this.$validate.isEmail(this.ruleForm.bumenzhuguanEmail))){
